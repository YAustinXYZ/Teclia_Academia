...
const features = [
  {
    title: 'Sube videos',
    description: 'Comparte lecciones en video y crea playlists de aprendizaje dinámico.',
  },
  {
    title: 'Sube canciones',
    description: 'Carga piezas, acompañamientos y tracks de práctica personalizados.',
  },
  {
    title: 'Organiza clases',
    description: 'Publica lecciones, notas y recursos en un panel claro y elegante.',
  },
  {
    title: 'Comparte teoría',
    description: 'Agrega artículos, escalas y partituras para tu comunidad de alumnos.',
  },
];
      ...
      <main>
        <section className="hero section-surface">
          <div className="hero-copy">
            ...
            <p className="hero-text">
              Teclia es la plataforma de enseñanza de piano diseñada para creadores, músicos y estudiantes exigentes.
          ...
          <div className="hero-panel">
            <div className="hero-card">
              ...
              <p>Sube videos, canciones, clases y teoría. Controla tu contenido y comparte tus mejores lecciones.</p>
        ...
        <section className="section-surface section-grid">
          <div className="section-intro">
            ...
            <h2>Una plataforma construida para músicos que quieren enseñar y aprender con estilo.</h2>
          </div>
          <div className="feature-grid">
            ...
            <article className="feature-card">
              ...
              <p>Sube contenidos, crea planes de estudio y organiza tu enseñanza en secciones claras.</p>
            </article>
            <article className="feature-card">
        ...
        <section className="section-surface section-studio" id="studio">
          <div>
            ...
            <h2>Sube contenido y comparte tu propuesta formativa</h2>
            <p className="section-copy">
              En Teclia, cada instructor puede publicar videos, canciones, notas y clases con una interfaz pensada para profesores profesionales.
            </p>
          </div>
        ...
        <section className="section-surface section-about" id="contacto">
          <div className="about-copy">
            ...
            <p>Mi nombre es [Tu Nombre], este proyecto será tu plataforma de enseñanza y espacio de crecimiento musical.</p>
